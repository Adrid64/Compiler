...
/*
	arithmetic: expression -> exp2:expression name:string exp3:expression
	expression -> 
...
public class Arithmetic extends AbstractExpression  {
	...
	public Arithmetic(Expression exp2, String name, Expression exp3) {
		super();
	...
	public Arithmetic(Object exp2, Object name, Object exp3) {
		super();
    ...
    public String toString() {
        return "Arithmetic{" + " exp2=" + this.getExp2() + " name=" + this.getName() + " exp3=" + this.getExp3() + "}";
    }
