...
/*
	booleanExp: expression -> exp2:expression name:string exp3:expression
	expression -> 
...
*/
public class BooleanExp extends AbstractExpression  {
	...
	public BooleanExp(Expression exp2, String name, Expression exp3) {
		super();
	...
	public BooleanExp(Object exp2, Object name, Object exp3) {
		super();
    ...
    public String toString() {
        return "BooleanExp{" + " exp2=" + this.getExp2() + " name=" + this.getName() + " exp3=" + this.getExp3() + "}";
    }
