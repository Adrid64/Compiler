...
*/
public class RestaUnaria extends AbstractExpression  {
	...
	public RestaUnaria(Expression exp2) {
		super();
	...
	public RestaUnaria(Object exp2) {
		super();
    ...
    public String toString() {
        return "RestaUnaria{" + " exp2=" + this.getExp2() + "}";
    }
